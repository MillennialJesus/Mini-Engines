const modifier = (text) => {
// inventory.js
// Regular Modular Inventory Engine with limited slots & weight

function createInventory({
  initialItems = [],
  maxSlots = 20,          // Default: 20 slots
  maxWeight = 50,         // Default: 50 lbs
  getItemWeight = (item) => item.weight ?? 0 // Per-item weight
} = {}) {
